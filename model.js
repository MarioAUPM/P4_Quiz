...
//Modelo de datos
//
//En esta variable se mantienen los quizzes existentes.
...
existe, y se producirá el error ENOENT. En este caso se salva el contenido inicial
almacenado en quizzes.
Si se produce otro tipo de error, se lanza una excepción que abortará la ejecucion del programa.
 */
...
/*
Actualiza el quiz situado en la posición indicada

@param id       Clave que identifica el quiz al actualizar.
@param question String con la pregunta.
@param answer   String con la respuesta.
 */
...
es decir, devuelve un objeto nuevo con todas las preguntas existentes.
